...
/**
 * Enforces, for this module's test code, the conventions the application tests are written
 * under: exact-value stubs and verifications (no lax Mockito matchers), no reflection, and
 * test names shaped as {@code should<Result>When<Condition>}.
 */
class TestConventionsTest {
    ...
    private static final JavaClasses testClasses = new ClassFileImporter()
        ...
        .importPackages("co.cobre.notifications.application");
